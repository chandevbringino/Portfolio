...
class SnackbarInfoPresenter: InfoPresenterProtocol {
  func presentInfo(
    ...
    MDCSnackbarManager.default.snackbarMessageViewBackgroundColor = info.backgroundColor
    MDCSnackbarManager.default.messageTextColor = info.foregroundColor

    message.text = info.message
    message.duration = info.duration
    message.completionHandler = { _ in
      onComplete()
    }
